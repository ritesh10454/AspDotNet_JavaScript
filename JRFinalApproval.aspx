<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="JRFinalApproval.aspx.vb" Inherits="JRFinalApproval" %>
    ...
    <div class ="col-md-12">
        <div class="card card-primary" style="margin-bottom: 5px;">
            <div class="card-header">
                <h3 class="card-title">Inbox (Final JR Approval)</h3>                
            </div>
...
<script src="Scripts/JRFinalApproval.js" type="text/javascript"></script>
