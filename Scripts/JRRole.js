...
$(document).ready(function () {
    ChangeBreadCrumb("Main", "JRRole", "Main");
...
function populateGrid(myData)
{
    ...
    {
        var table = $('#JRRoleTable').removeAttr("width").DataTable({
            "JQueryUI" : false,
            "paging": false,
            "processing": true,
            "deferRender" : true,
...
{
    $('#JRRoleTable').removeAttr("width").DataTable({
	    "processing": true,
	    "language": 
        {
		    "emptyTable": "No Data Found"
...
function getJRRoles() {
    return new Promise(function (resolve, reject) {
        $.ajax({
            type: "POST",
            url: "WebService.asmx/GetJRRoles",
            data: "{}",
