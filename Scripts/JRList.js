...
async function BindGrid() 
{
    ...
    try 
    {
        ...
        if(usercd.length > 0)
        {
            ...
            if(tag!=0)
            {
            if(tag==1){$("[id*=jrListID]").text("Pending JR");  } 
                else if(tag==2){$("[id*=jrListID]").text("Complete JR"); }

//                if(tag==1){$("[id*=jrListID]").text("JR not initialize");  } 
//                else if(tag==2){$("[id*=jrListID]").text("Not Approved by User"); }
//                 else if(tag==3){$("[id*=jrListID]").text("Not Approved by HOD"); }
//                  else if(tag==4){$("[id*=jrListID]").text("Not Approved by HRM"); }
//                   else if(tag==5){$("[id*=jrListID]").text("Completed by First Authority"); }
//                    else if(tag==6){$("[id*=jrListID]").text("Approved by User"); }
//                     else if(tag==7){$("[id*=jrListID]").text("Approved by HOD"); }
//                     else if(tag==8){$("[id*=jrListID]").text("Approved by HRM"); }
...
function populateGrid(myData)
{
	$(document).ready(function() {
		...
		{
			var table = $('#PendingJRTable').DataTable({
				"JQueryUI" : false,
				"paging": false,
				"processing": true,
				"deferRender" : true,
