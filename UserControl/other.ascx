<%@ Control Language="VB" AutoEventWireup="false" CodeFile="other.ascx.vb" Inherits="UserControl_other" %>
<%@ Register Src ="Sidebar.ascx" TagPrefix ="Sb" TagName ="Sidebar" %>
<%--  <!-- Preloader -->
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="#" class="nav-link" style ="font-size: x-large;text-transform: uppercase;color: rgba(87, 21, 132, 0.87);font-weight: 800;">ONLINE JOB RESPONSIBILITY MODULE</a>
        </li>
