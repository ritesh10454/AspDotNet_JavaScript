<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="JRAccessRight.aspx.vb" Inherits="JRAccessRight" %>
        ...
        <div class="col-md-12">
            <div class="card card-primary" style="margin-bottom: 5px;">
                <div class="card-header">
                    <h3 class="card-title" id="jrListID">JR Access Rights</h3>
                </div>
...
<script src="Scripts/JRAccessRight.js" type="text/javascript"></script>
