<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="JRList.aspx.vb" Inherits="JRList" %>
        ...
        <div class="col-md-12">
            <div class="card card-primary" style="margin-bottom: 5px;">
                <div class="card-header">
                    <h3 class="card-title" id="jrListID"></h3>
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
								<div class="table table-bordered table-striped  dt-responsive" id="PendingJRDIV" style="width: 100%;">
									<table id="PendingJRTable" border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-striped dt-responsive" style="width: 100%;">
										<thead>
											<tr>
												<th>Sr No</th>
												<th>Employee Code</th>
...
<script src="Scripts/JRList.js" type="text/javascript"></script>
