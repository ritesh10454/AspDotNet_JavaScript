<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" ClientIDMode="Static" CodeFile="CHECKMIV.aspx.vb" Inherits="CHECKMIV" %>
    ...
    <div class ="col-md-12">
        <div class="card card-primary" style="margin-bottom: 5px;">
            <div class="card-header">
                <h3 class="card-title">CHECK MIV.</h3>
            </div>
                ...
                <div class="card-body" style="padding:0;">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4">
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-6 col-form-label LabelAlign">Enter MIV No</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control TextAlign" id="txtMIVNo" placeholder="MIV No." onkeydown="return (event.keyCode!=13);" onkeypress="return validateFloatKeyPress(this,event);" />
                        ...
                        <div class="col-sm-12 col-md-4">
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-6 col-form-label LabelAlign">Enter MIV Year</label>
                                    <div class="col-sm-6">
                                        <input type="text"  class="form-control TextAlign" id="txtMIVYR" placeholder="MIV Year"   onkeydown="return (event.keyCode!=13);" onkeypress="return validateFloatKeyPress(this,event);" maxlength="4"  />
                                    </div>
                                </div>
                        </div>
                    </div>     
...
<script src="Scripts/CHECKMIV.js" type="text/javascript"></script>
